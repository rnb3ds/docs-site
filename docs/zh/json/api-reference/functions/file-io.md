...
description: "CyberGo JSON 文件操作函数完整参考：包括 LoadFromReader 从流读取、ParseJSONL/ToJSONL JSONL 处理、StreamLinesInto[T] 泛型流处理、NewJSONLWriter 写入器，以及 JSONL 配置详解，支持 Go 大文件流式处理场景。"
---
