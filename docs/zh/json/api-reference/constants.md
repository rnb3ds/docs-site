...
description: "CyberGo JSON 常量与错误定义完整参考：包括 DefaultMaxJSONSize/DefaultMaxNestingDepth 默认限制常量、ErrPathNotFound/ErrTypeMismatch 等错误变量和 MergeMode 合并模式枚举，提供 Go 配置预设与错误处理支持。"
---
