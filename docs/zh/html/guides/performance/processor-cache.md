...
description: "CyberGo html Processor 复用与缓存指南：包函数与 Processor 实例的核心区别与选择策略、sync.Pool 内部复用机制、缓存策略配置、GetStatistics 命中率监控与 Web 服务单例复用的最佳实践。"
sidebar_position: 1
---
...
- [性能优化](./performance) - 更多性能调优技巧
- [批量处理实战](./batch-processing) - 并发批量提取
