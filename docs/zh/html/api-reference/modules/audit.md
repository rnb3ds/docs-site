...
description: "CyberGo html 可插拔审计系统 API 参考：AuditConfig 全字段配置、8 种审计事件类型（阻止标签、属性、URL、输入违规等）、Info/Warning/Critical 三级、AuditEntry 结构与 Logger/Writer/Channel 等六种内置 Sink 及级别过滤管道。"
sidebar_position: 4
---
