...
> 📖 **使用教程** · 完整 API 签名见 [钩子系统 - HookRegistry](../../api-reference/core/hooks)
...
- [审计日志](../security/audit-logging) -- 安全审计集成
- [分布式追踪](../integration/context-tracing) -- 上下文集成
- [API 参考 - Hooks](../../api-reference/core/hooks) -- 钩子完整 API
