---
title: "中间件链 - HTTPC"
description: "HTTPC 中间件链指南：洋葱模型执行原理与请求/响应双向处理、Recovery/Logging/RequestID/Timeout/Header/Metrics/Audit 八个内置中间件配置、Chain 手动组合模式、自定义 MiddlewareFunc 编写与断路器短路中间件示例。"
---
