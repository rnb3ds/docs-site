...
description: "CyberGo html constants and errors: MaxInputSize/CacheTTL defaults, audit event constants, sentinel errors, InputError/ConfigError/FileError for errors.Is/As."
sidebar_position: 3
---
