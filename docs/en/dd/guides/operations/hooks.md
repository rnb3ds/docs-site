...
- [Audit Logging](../security/audit-logging) -- Security audit integration
- [Distributed Tracing](../integration/context-tracing) -- Context integration
- [API Reference - Hooks](../../api-reference/core/hooks) -- Complete hook API
