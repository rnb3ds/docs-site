...
description: HTTPC domain client API reference, covering NewDomain creation, seven HTTP methods, four download methods, URL auto-concatenation, session headers, and cookie management.
---
