...
title: "Часто задаваемые вопросы - CyberGo env | выбор Load/New"
description: "Ответы на частые вопросы CyberGo env: глобальный режим или экземпляр, однократная инициализация Load, вложенные ключи JSON и потокобезопасный доступ."
sidebar_position: 2
---
