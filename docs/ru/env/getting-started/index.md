...
description: "Быстрый старт с CyberGo env за 5 минут: установка go get, загрузка .env, типобезопасное чтение, GetSecure и маппинг структур с исполняемыми примерами."
sidebar_position: 1
---
...
::: tip Полный справочник по синтаксису
Полные правила синтаксиса `.env` (кавычки, экранирование, многострочные значения) см. в разделе [Формат файлов](/ru/env/reference/file-format).
:::
