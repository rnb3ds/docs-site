...
title: "Маскирование данных - CyberGo env | защита логов"
description: "Руководство по маскированию данных CyberGo env: IsSensitiveKey для автообнаружения паролей, MaskValue и SanitizeForLog для безопасных логов."
sidebar_position: 2
sidebar_icon: "🛡️"
---
...
Маскирует само имя ключа для сценариев, где нужно показать наличие ключа, не раскрывая его смысл (публичный API `MaskKey` — обёртка над внутренней процедурой маскирования, разделяющая одну реализацию с отчётами об ошибках и журналами аудита):
