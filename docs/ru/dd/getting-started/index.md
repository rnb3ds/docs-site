...
- [Основные концепции](../guides/basics/core-concepts) -- понимание архитектуры Logger и конвейера обработки
- [Структурированное логирование](../guides/basics/structured-logging) -- подробное описание использования полей
- [Вывод в файл и ротация](../guides/basics/file-output) -- подробное описание FileWriter
- [Фильтрация конфиденциальных данных](../guides/security/sensitive-filtering) -- практикум по фильтрации безопасности
