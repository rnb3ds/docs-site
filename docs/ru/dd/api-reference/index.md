...
| Модуль | Описание | Документация |
|--------|----------|-------------|
| **Fields** | Конструкторы структурированных полей (20 типов) | [Структурированные поля](./core/fields) |
| **Hooks** | Система хуков жизненного цикла | [Система хуков](./core/hooks) |
...
| **Constants** | Уровни логирования, форматы, коды ошибок | [Константы и ошибки](./core/constants) |
