...
|-------------|----------|-------------|
| Фильтрация конфиденциальных данных | Автоматическое маскирование паролей, API-ключей и т.д. | [Фильтрация конфиденциальных данных](../security/sensitive-filtering) |
| Аудитные логи | Асинхронная запись событий безопасности | [Аудитные логи](../security/audit-logging) |
| HMAC-подписи | Защита логов от подделки | [Практика HMAC-подписей](../security/integrity) |
| Отраслевое соответствие | Предустановки HIPAA/PCI-DSS | [Конфигурация отраслевого соответствия](../security/compliance) |
| Хуки жизненного цикла | 6 типов событий Hook | [Система хуков](../operations/hooks) |
| LoggerRecorder | Утилита тестирования | [Паттерны тестирования](../../examples/testing-patterns) |

## Следующие шаги

- [Основные концепции](../basics/core-concepts) -- обзор архитектуры DD
- [Структурированное логирование](../basics/structured-logging) -- подробное описание использования полей
