...
title: "TLS и закрепление сертификатов - CyberGo HTTPC | Шифры и закрепление"
description: "Руководство по TLS и закреплению сертификатов HTTPC: управление версиями TLS 1.2-1.3 и настройка безопасных шифровальных наборов, загрузка пользовательских CA-сертификатов, двусторонняя аутентификация mTLS, API закрепления сертификатов CertificatePinner и согласование HTTP/2 — безопасные настройки по умолчанию из коробки, строящие линию защиты шифрования транспортного уровня."
sidebar_position: 3
---
