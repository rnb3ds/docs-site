...
description: "Справочник API загрузки файлов HTTPC: четыре сигнатуры функций загрузки DownloadFile, структура конфигурации DownloadConfig, обратный вызов прогресса DownloadProgressCallback, тип результата DownloadResult, проверка контрольных сумм SHA-256 и шесть уровней защиты безопасности, включая предотвращение UNC-путей."
---
...
| Фильтрация управляющих символов | Запрет управляющих символов в путях |
