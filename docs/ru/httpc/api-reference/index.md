...
description: "Индекс справочника API HTTPC: навигация по трём группам — ядро, запросы/ответы и продвинутые функции; охватывает функции HTTP уровня пакета, 28 опций запроса WithXxx, систему конфигурации Config с пятью пресетами, семь встроенных middleware, доменный клиент, загрузку файлов и типы ошибок — поможет быстро найти нужный API."
sidebar_position: 1
---
...
| [Промежуточное ПО](./client-config/middleware) | Композиция Chain, 7 встроенных фабрик middleware и типы событий аудита |
