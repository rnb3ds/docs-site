...
| [Руководство по Processor](./getting-started/processor-guide) | Когда использовать Processor, оптимизация предпарсинга, жизненный цикл |
...
- **Параллельная потоковая обработка** — потоковая обработка JSONL поддерживает параллелизм с несколькими воркерами (`StreamJSONLParallel`)
