...
Полные сигнатуры типов интерфейса Hook (`Hook`, `HookContext`, `HookFunc`) см. в [Определения интерфейсов](../api-reference/interfaces#интерфейс-перехватчика). Эта страница посвящена руководству по использованию и лучшим практикам.
:::
