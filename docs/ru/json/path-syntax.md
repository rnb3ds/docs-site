...
description: "Полный справочник по синтаксису выражений пути CyberGo JSON, включая доступ к свойствам user.name, индексацию массивов items[0], срезы [start:end:step], подстановочные знаки [*], извлечение нескольких полей {name,email} и другие конструкции для гибкого и точного доступа к любым узлам JSON-данных в Go."
---
