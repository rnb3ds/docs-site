...
Эта страница — руководство по миграции для функций серии Print (удалённых в более ранней версии). Для форматирования JSON используйте [`Prettify`](../api-reference#форматирование) или совместимый со стандартной библиотекой `MarshalIndent`.
:::
