...
- [Форматы вывода на практике](../guides/core-features/output-formats) - Выбор подходящего формата для вашего сценария
- [Повторное использование Processor и кэш](../guides/performance/processor-cache) - Оптимизация производительности при высокочастотных вызовах
