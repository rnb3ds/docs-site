...
description: "CyberGo html — быстрая Go-библиотека извлечения и очистки HTML: умное распознавание статей, 15+ кодировок, Markdown/JSON, ссылки и медиа, пакеты, аудит, защита."
---
...
| Ошибки | [Обработка ошибок](./guides/performance/error-handling) | Пять типов ошибок, errors.Is/As, отмена context |
