---
sidebar_label: "Обзор"
title: "HTML - CyberGo html | извлечение и очистка контента"
description: "CyberGo html — быстрая Go-библиотека извлечения и очистки HTML-контента: распознавание статей, автоопределение кодировок и многоформатный вывод."
---
