...
description: "Обработка ошибок CyberGo html: пять категорий (ввод, конфигурация, файлы, обработка, система), errors.Is/As, тайм-ауты context, частичные неудачи и паники."
sidebar_position: 4
---
...
- [Справочник API: константы и ошибки](../../api-reference/types/constants) - полный список сигнатурных ошибок
- [Справочник API: Processor](../../api-reference/core/processor) - жизненный цикл Processor и статистика
