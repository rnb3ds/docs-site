...
- [Оптимизация производительности](./performance) - Дополнительные советы по оптимизации
- [Пакетная обработка на практике](./batch-processing) - Параллельное пакетное извлечение
