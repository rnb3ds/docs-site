...
description: "Извлечение контента CyberGo html: процесс — валидация, кодировки, DOM, санитизация, распознавание статей; скоринг, поля Result, пользовательский Scorer."
sidebar_position: 1
---
...
Встроенный скорер по умолчанию (внутренняя реализация, не экспортируется) вычисляет комплексную оценку на основе многомерных сигналов и выбирает контейнер с наибольшим количеством баллов:
