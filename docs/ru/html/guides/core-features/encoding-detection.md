...
description: "Кодировки CyberGo html: приоритет четырёх уровней — Config.Encoding, meta-тег, статистика, UTF-8; 15+ кодировок, примеры GBK, Shift_JIS, Windows-1252."
sidebar_position: 5
---
...
- [Обработка ошибок](../performance/error-handling) - сигнатурные ошибки и структурированная обработка ошибок
