...
description: "Интеграция CyberGo html с net/http: одиночный и пакетный скрейпинг, Processor-синглтон для веб-сервисов, экспоненциальный повтор, тайм-ауты, продакшен."
sidebar_position: 1
---
...
- [Кэширование и повторное использование](../performance/processor-cache) - Управление жизненным циклом Processor
- [Система аудита на практике](../security/audit-pipeline) - Мониторинг безопасности в производственной среде
- [Справочник API: Пакетная обработка](../../api-reference/modules/batch) - Полный API пакетной обработки
- [Оптимизация производительности](../performance/performance) - Советы по оптимизации
