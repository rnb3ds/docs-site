...
description: "CyberGo JSON バリデータ完全リファレンス：Validator インターフェース定義、Schema バリデーション構造、ValidationError バリデーションエラー型、SchemaConfig 設定オプション、カスタムバリデータ実装ガイドを含み、Go の完全な JSON データ構造とコンテンツのバリデーション機能を提供。"
---
