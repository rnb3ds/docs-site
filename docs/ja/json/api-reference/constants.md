...
description: "CyberGo JSON 定数とエラー定義完全リファレンス：DefaultMaxJSONSize/DefaultMaxNestingDepth デフォルト制限定数、ErrPathNotFound/ErrTypeMismatch エラー変数、MergeMode マージモード列挙型を含み、Go の設定プリセットとエラー処理をサポート。"
---
