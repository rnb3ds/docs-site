---
title: "出力フォーマット - HTML"
description: "CyberGo HTML の出力フォーマット API リファレンス。ExtractToMarkdown、ExtractToJSON のパッケージ関数と Processor メソッドでバイト/ファイルを Markdown/JSON に変換し Result のカスタム直列化をサポートします。"
---
