...
description: "CyberGo JWT はプロダクションレディな Go 認証ライブラリで、HMAC・RSA・RSA-PSS・ECDSA 4 種 12 アルゴリズムをサポートし、トークン発行・検証・リフレッシュ・失効、ブラックリスト、レート制限、カスタム Claims、クロック注入を提供。全メソッドが並行安全。"
---
