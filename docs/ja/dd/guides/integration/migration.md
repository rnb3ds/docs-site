...
| 機能 | 説明 | ドキュメント |
|------|------|------|
| 機密データフィルタリング | パスワード、API Key などの自動マスキング | [機密データフィルタリング](../security/sensitive-filtering) |
| 監査ログ | 非同期セキュリティイベント記録 | [監査ログ](../security/audit-logging) |
| HMAC 署名 | ログの改ざん防止 | [HMAC 署名実践](../security/integrity) |
| 業界コンプライアンス | HIPAA/PCI-DSS プリセット | [業界コンプライアンス設定](../security/compliance) |
| ライフサイクルフック | 6 種類の Hook イベント | [フックシステム](../operations/hooks) |
| LoggerRecorder | テスト補助 | [テストパターン](../../examples/testing-patterns) |

## 次のステップ

- [コア概念](../basics/core-concepts) -- DD アーキテクチャ概要
- [構造化ログ](../basics/structured-logging) -- フィールド使用詳解
