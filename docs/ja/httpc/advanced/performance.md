...
description: "HTTPC パフォーマンス最適化ガイド：Default/Secure/Performance/Minimal 4 種類のプリセット比較とシナリオ選択、プリセットベースの接続プールとタイムアウト微調整、内蔵オブジェクトプール自動管理による GC 負荷軽減とよくあるパフォーマンスアンチパターン分析。"
---
