...
description: "HTTPC API リファレンス索引：コア、リクエスト/レスポンス、高度な機能の 3 グループ分類でナビゲート。パッケージレベル HTTP 関数、28 個の WithXxx リクエストオプション、Config 設定システムと 5 種のプリセット、7 つの内蔵ミドルウェア、ドメインクライアント、ファイルダウンロード、エラータイプの完全な参照入口で、必要な API を素早く特定できます。"
sidebar_position: 1
---
...
| [ミドルウェア](./client-config/middleware) | Chain 組み合わせ、7 つの内蔵ミドルウェアファクトリ、監査イベントタイプ |
