...
description: "HTTPC API リファレンス索引：コア、リクエスト/レスポンス、高度な機能の 3 グループで分類したナビゲーション。パッケージレベル HTTP 関数、27 個の WithXxx リクエストオプション、Config 設定システムと 5 つのプリセット、8 つの内蔵ミドルウェアファクトリ、ドメインクライアントとセッション管理、ファイルダウンロードとレジューム、エラータイプと定数列挙を網羅します。"
---

# API リファレンス

HTTPC は 27 個のリクエストオプション関数、5 つの設定プリセット、8 つの内蔵ミドルウェア、完全なダウンロードサポートを提供します。
