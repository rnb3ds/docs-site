...
description: "CyberGo env 는 고보안 Go 환경 변수 관리 라이브러리로, .env·JSON·YAML 자동 감지, 타입 안전 변환, SecureValue 잠금·제로화, 샤드 락 스레드 안전, ${VAR} 확장, env 태그 매핑, 감사 로그로 마이크로서비스·클라우드 네이티브 설정 지원."
---
...
### 시작하기
- [빠른 시작](/ko/env/getting-started/) - 5 분 시작 튜토리얼
