...
description: "CyberGo JWT 커스텀 Claims 가이드: CustomClaims 인터페이스로 비즈니스 전용 선언 필드 정의, 내장 Claims와 커스텀 타입의 검증 차이 비교, ValidateInto·RefreshInto 사용법과 RateLimitKeyer 인터페이스."
---
