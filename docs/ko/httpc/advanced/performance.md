---
title: "성능 최적화 - HTTPC"
description: "HTTPC 성능 최적화 가이드: Default/Secure/Performance/Minimal 네 가지 프리셋 비교와 시나리오별 선택, 프리셋 기반 미세 조정 연결 풀과 타임아웃, ReleaseResult 객체 풀 재사용으로 GC 부하 절감과 일반적인 성능 안티패턴."
---
