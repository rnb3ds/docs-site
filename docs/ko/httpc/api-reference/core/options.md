...
description: "HTTPC 요청 옵션 API 레퍼런스: WithHeader 요청 헤더, WithBearerToken 인증, WithJSON/WithForm 요청 본문, WithQuery 쿼리 매개변수, Cookie 옵션과 WithOnRequest/WithOnResponse 콜백 함수."
sidebar_position: 2
---
...
단일 요청 헤더를 설정합니다. 키와 값은 보안 검증을 거칩니다(CRLF 주입 방어).
