...
description: "HTTPC API 레퍼런스 색인: 핵심, 요청 응답, 고급 기능 세 그룹으로 분류된 탐색으로 패키지 함수, 28개 WithXxx 요청 옵션, Config 설정 시스템과 5가지 프리셋, 7개 내장 미들웨어, 도메인 클라이언트, 파일 다운로드와 오류 타입의 완전한 참조 진입점을 제공하여 필요한 API를 빠르게 찾을 수 있습니다."
sidebar_position: 1
---
...
| [미들웨어](./client-config/middleware) | Chain 조합, 7개 내장 미들웨어 팩토리와 감사 이벤트 타입 |
