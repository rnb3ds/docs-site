---
title: API 참조 - HTTPC
description: HTTPC API 참조 인덱스, 기능별로 분류된 패키지 함수, Client 인터페이스, 요청 옵션, 미들웨어, 오류 유형, 구성과 상수 상세 문서 링크.
---
...
| 모듈 | 설명 |
|------|------|
| [패키지 함수](./functions) | Get/Post/Put/Patch/Delete 등 패키지 함수, 클라이언트 메서드 및 보조 함수 |
| [구성](./config) | Config 구조체, 5가지 프리셋 구성, 검증 함수 및 Cookie 보안 |
| [인터페이스](./interfaces) | Client, Doer, DomainClienter, RetryPolicy 등 핵심 인터페이스 |
| [Result](./result) | Result, RequestInfo, ResponseInfo, RequestMeta 유형 및 모든 메서드 |
...
| [미들웨어](./middleware) | Chain 조합, 8개의 내장 미들웨어 팩토리 및 감사 이벤트 유형 |
| [오류 유형](./errors) | ClientError, 12가지 ErrorType 열거형 및 13개의 오류 변수 |
...
| [상수와 유형](./constants) | BodyKind 열거형, FormData/FileData 및 감사 컨텍스트 키 |
