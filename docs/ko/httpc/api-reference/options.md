---
title: "요청 옵션 - HTTPC"
description: "HTTPC 27개 요청 옵션 함수 API 레퍼런스: WithHeader 요청 헤더, WithBearerToken 인증, WithJSON/WithXML/WithForm/WithBinary 다양한 요청 본문, WithQuery 쿼리 매개변수, 5가지 Cookie 옵션과 WithOnRequest/WithOnResponse 콜백."
---

# 요청 옵션

요청 옵션은 함수형 구성 항목으로, `RequestOption` 타입을 통해 요청 메서드에 전달하여 세밀한 요청 제어를 구현합니다.
...
URL 인코딩 폼 요청 본문을 설정하며, 자동으로 `Content-Type: application/x-www-form-urlencoded`를 추가합니다.
