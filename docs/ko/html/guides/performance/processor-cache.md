...
description: "CyberGo html Processor 재사용과 캐시 가이드: 패키지 함수와 인스턴스 차이, sync.Pool 메커니즘, MaxCacheEntries·CacheTTL 캐시 전략과 적중률 모니터링, 웹 서비스 싱글톤 실전을 다룹니다."
sidebar_position: 1
---
...
- [성능 최적화](./performance) - 더 많은 성능 튜닝 팁
